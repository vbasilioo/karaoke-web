    ...
    <div className="w-full min-h-screen bg-zinc-950 text-white overflow-hidden">
      <nav className="w-full backdrop-blur-sm bg-zinc-900/80 border-b border-zinc-800">
        <div className="container mx-auto flex justify-between items-center px-6 py-4">
            ...
            {[
              ...
              <Popover key={label}>
                <PopoverTrigger asChild>
                  <button onClick={() => handlePopoverClick(content)}>
          ...
          <Button asChild>
            <Link
              href="/auth/administrador-entrar"
              className="text-white font-bold py-2 px-4 rounded-full bg-gradient-to-r from-pink-500 to-blue-500 hover:opacity-90 transition"
            >
      ...
      <div className="lg:grid lg:grid-cols-2 min-h-[calc(100vh-64px)]">
        <div className="flex items-center justify-center px-6 py-16 animate-fade-in">
          <div className="text-center space-y-6 max-w-md">
            <h1 className="text-4xl lg:text-5xl font-extrabold leading-tight text-white drop-shadow">
        ...
        <div className="hidden lg:flex items-center justify-center bg-zinc-800">
          <Image
